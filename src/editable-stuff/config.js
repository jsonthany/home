...
const mainBody = {
  ...
  middleName: "",
  lastName: "Thany",
  message: " Software Engineer | Ex-Management Consultant ",
  icons: [
    {
      image: "fa-github",
      url: "https://github.com/jsonthany",
    },
    // {
    //   image: "fa-facebook",
    ...
    {
      image: "fa-linkedin",
      url: "https://www.linkedin.com/in/jasonthany/",
    },
    {
      image: "fa-instagram",
      url: "https://www.instagram.com/jasonthany/",
    },
    // {
    //   image: "fa-twitter",
...
const repos = {
  ...
  gitHubUsername: "jsonthany", //i.e."johnDoe12Gh"
  reposLength: 0,
  specificRepos: ["movie_tinder", "networthify", "stock_bot", "chrome_ext_pomodoro"],
};
...
const leadership = {
  ...
  images: [
    { 
      img: require("../editable-stuff/jsonthany.png"), 
...
const experiences = {
  ...
  data: [
    ...
    },
    {
      ...
      companylogo: require('../assets/img/kearney.jpeg'),
